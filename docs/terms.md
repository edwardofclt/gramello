...
## Who can use Gramello

You must be at least 13 years old to use Gramello. If you are under the age of
legal adulthood where you live, a parent or legal guardian must review and agree
...
Gramello helps you record foods, nutrition, water, and personal goals. It does
not provide medical advice, diagnosis, treatment, or individualized dietary
advice. Goals and example values are not a prescription or a recommendation for
your needs. Consult a qualified health professional about medical conditions,
dietary restrictions, or changes to your nutrition or hydration.

Do not rely on Gramello to make emergency or safety-critical decisions,
including medication dosing, allergy management, or treatment decisions. If
tracking food is affecting your wellbeing, consider pausing and seeking
...
If you discover a security issue, email support with enough detail to investigate
and avoid accessing or exposing anyone else's information.
...
Gramello's branding, website, and original content are protected by applicable
intellectual-property law. You may use the service for its intended purpose.
Do not copy our branding to impersonate Gramello or imply our endorsement.
Third-party data, software, images, and trademarks remain subject to their
respective owners' rights and applicable licenses. Any license expressly
included with repository code or third-party material governs that material.

## Disclaimers and responsibility

To the extent permitted by applicable law, Gramello is provided "as is" and
"as available," without warranties of uninterrupted operation, accuracy, or
fitness for a particular purpose. We do not guarantee a health, fitness, weight,
or nutrition outcome from using Gramello.

To the extent permitted by applicable law, we are not responsible for indirect,
incidental, special, or consequential losses arising from use of the service,
including losses caused by inaccurate third-party food information. Nothing in
these terms excludes or limits responsibility that cannot lawfully be excluded
or limited, or any mandatory consumer protections available to you.
...
with a regulator available under applicable law.

## Updates and contact

We may update these terms as the product changes. The effective date identifies
...
Gramello is provided by Edward Herbert II. Email
[gramello@edwardofclt.com](mailto:gramello@edwardofclt.com) for support or questions
about these terms.
